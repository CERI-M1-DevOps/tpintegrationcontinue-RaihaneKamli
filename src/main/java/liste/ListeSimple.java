...
public class ListeSimple {
     ...
     * @param nouvelleValeur La nouvelle valeur pour l'élément trouvé.
     */
     ...
     * @param element L'élément à rechercher.
     * @param nouvelleValeur La nouvelle valeur pour chaque occurrence de l'élément.
     */
     ...
     * @param element L'élément à supprimer.
     * @param tete La tête de la liste actuelle.
     * @return La tête de la liste mise à jour.
     */
    ...
    /**
     * Obtient l'avant-dernier nœud de la liste.
     * @return L'avant-dernier nœud, ou null si la liste est vide ou contient un seul nœud.
     */
    ...
    /**
     * Obtient le nœud précédent d'un nœud donné dans la liste.
     * @param r Le nœud pour lequel on recherche le précédent.
     * @return Le nœud précédent de r.
     */
